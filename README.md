...
See [docs/mcp-client-setup-runbook.md](docs/mcp-client-setup-runbook.md) for repeatable Codex, OpenClaw, Claude Code, and opencode setup and verification, including [persistent macOS GUI credentials](docs/mcp-client-setup-runbook.md#macos-gui-credentials).
